...
meter=$(/usr/bin/osascript << EOT
  tell application "Finder"
  activate
  set x42meters to { "EBU R128", "K20/RMS", "True-Peak and RMS Meter", "DR14 - Dynamic Range", "Goniometer", "Phase-Correlation", "Phase/Frequency Wheel", "Stereo/Frequency Scope", "Signal Distribution Histogram", "Spectrum Analyzer", "Bit Meter", "BBC Meter", "BBC M-6", "DIN Meter", "EBU Meter", "Nordic Meter", "VU Meter" }
