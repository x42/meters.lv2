...
static const RtkLv2Description _plugin_din2c = {
	&lv2_descriptor,
	&lv2ui_needle
	, 7 // uint32_t dsp_descriptor_id
	, 0 // uint32_t gui_descriptor_id
	, "DIN Meter (Stereo)" // const char *plugin_human_id
	, (const struct LV2Port[7])
	{
		{ "ref", CONTROL_IN, -15.000000, -30.000000, 0.000000, "Reference Level 0dBu"},
...
#endif
#define X42_PLUGIN_STRUCT _plugin_din2c
