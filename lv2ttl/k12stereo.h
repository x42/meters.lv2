...
static const RtkLv2Description _plugin_k12stereo = {
	&lv2_descriptor,
	&lv2ui_kmeter
	, 35 // uint32_t dsp_descriptor_id
	, 0 // uint32_t gui_descriptor_id
	, "K12/RMS Meter (Stereo)" // const char *plugin_human_id
...
#endif
#define X42_PLUGIN_STRUCT _plugin_k12stereo
